...
I am writing to apply for the position of Assistant Professor of Data Science as advertised on APSA.
I am a doctoral candidate specializing in political economy with particular focus on political communication and timing of elections.
I will complete my Ph.D. in Economics from the University of Illinois, Urbana-Champaign in May 2022. 

I am extremely interested in joining the faculty of UCL.
As a member of the department, I will contribute to its focus on political science and public policy education,
continue my research on strategic communication and the political economy of public policy, and lead departmental service activities.
%
I find UCL's tradition for teaching and its research philosophy very stimulating.
...
%%% START: Own Research %%%
My research examines issues in political economy.
...
As part of the empirical analysis, I employ both machine learning (supervised learning) and natural language techniques to classify political ads into distinct classes based on their content.
...
% I find the work being done at <UNIVERSITY APPLY> very exciting and stimulating.
...
Drawing from my research and teaching experiences, I am confident that I would be great fit to teach "The Politics of Public Policy", "Statistical Learning for Public Policy" and "Quantitative Text Analysis.
...
Letters in support of my application from Professors Dan Bernhardt (Chair), George Deltas, and Stefan Krasa will be sent under a separate cover can be requested from my department's proxy person Tera Martin-Roy at econ-phdjobs@illinois.edu.
