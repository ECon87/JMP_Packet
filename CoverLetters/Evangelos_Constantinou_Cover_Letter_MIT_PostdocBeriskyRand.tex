...
I am writing to apply for the position of Postdoctoral Associate with Professors Berinsky and Rand as advertised on APSA.
I am a doctoral candidate specializing in political economy particular focus on political advertising and communication.
I will complete my Ph.D. in Economics from the University of Illinois, Urbana-Champaign in May 2022. 

I am extremely interested in joining the research group to examine the incentives to believe and disseminate misinformation.
My job market paper examines the incentives of political candidates to target tailored content to specific groups of voters.
Specifically, I theoretically and empirically analyze how politicians strategically vary ad content and placement to mobilize their base and demobilize the opposing one.
My work naturally extends to strategic dissemination of fake news and misleading hyper-partisan content.
This is a direction in which I am excited to extend my research.
In particular, I wish to examine how polarization makes voters more susceptible to fake news and misinformation, and how political candidates exploit such tactics for mobilization purposes.


During my research and studies I have gained and honed skills that make me an excellent fit for the Postdoctoral Associate position, including:
\begin{itemize}
    \item proficient in theoretical and empirical economic modeling centered on agent decision-making,
    \item expertise in advanced statistical, econometric and data analysis,
    \item experience with computational skills such as machine learning and natural language processing,
...
Letters in support of my application from Professors Dan Bernhardt (Chair), George Deltas, and Stefan Krasa can be requested by the proxy of our department TeraMartin-Roy at econ-phdjobs@illinois.edu (or tnmartin@illinois.edu).
